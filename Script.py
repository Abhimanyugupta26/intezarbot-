...
• /deletefiles - <code>Tᴏ ᴅᴇʟᴇᴛᴇ CᴀᴍRɪᴘ ᴀɴᴅ PʀᴇDVD Fɪʟᴇs ғʀᴏᴍ ᴛʜᴇ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ.</code>"""
    ...
    STATUS_TXT +918877040615 """<b>★ Tᴏᴛᴀʟ Fɪʟᴇs: <code>{}</code>
...
›› sᴛᴇᴘ 𝟹 : ғᴏʟʟᴏᴡ ᴛʜᴇsᴇ ɪɴꜱᴛʀᴜᴄᴛɪᴏɴꜱ https://t.me/movies_bot_suport/613
...
• ꜰᴜʟʟ ɴᴀᴍᴇ : Abhimanyu Gupta 
• ᴜꜱᴇʀɴᴀᴍᴇ : @abhimanyu_Gupta_26
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='https://t.me/Abhimanyu_Gupta_26'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a> 
    <b>"""
...
<b>
╭─────── • ◆ • ───────╮
🔅 OFFICIAL CHANNEL: : @LbHmoviebackup🌑
╰─────── • ◆ • ───────╯
